...
class Document {
  ...
  get modified_time() {
    ...
    return moment.tz(this.data.modified_time, velvet.config.timezone);
  }
  ...
  get created_time() {
    ...
    return moment.tz(this.data.created_time, velvet.config.timezone);
  }
